                    ...
                    <nav id="navigation">
                        <ul>
                            ...
                            <li class="has_submenu">
                                <a href="#">Properti</a>
                                <ul>
                                    <li><a href="new-property.html">Buat baru properti</a></li>
                                    <li><a href="property-detail.html">Properti selengkapnya</a></li>
                                    <li><a href="properties-listing-grid-rc.html">Daftar properti</a></li>
                                </ul>
                            </li>
                            <li class="has_submenu"><a href="#">Halaman</a>
                                <ul>
                            ...
                            <li class="has_submenu">
                                <a href="#">Agen</a>
                                <ul>
                                    <li><a href="create-agency.html">Buat agen</a></li>
                                    <li><a href="agent-detail.html">Agen detail</a></li>
                                    <li><a href="agents-listing.html">Daftar agen</a></li>
                                </ul>
                            </li>
                            <li class="has_submenu">
                            ...
                            <li><a href="<?php base_url('blok/index'); ?>">Blok</a></li>
