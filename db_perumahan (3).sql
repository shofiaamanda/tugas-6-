...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 02, 2020 at 08:09 AM
...
INSERT INTO `tb_komentar` (`id_komentar`, `id_properti_komentar`, `id_user_komentar`, `komentar_properti`, `rating_properti`, `foto1_komentar`, `foto2_komentar`, `foto3_komentar`) VALUES
(1, 1, 1, 'Perumahan terbagus dan terbaik', 4, '', '', '');
...
CREATE TABLE `tb_properti` (
  ...
  `harga_properti` int(11) NOT NULL,
  `tempat_tidur` int(11) NOT NULL,
  `tempat_mandi` int(11) NOT NULL,
...
INSERT INTO `tb_properti` (`id_properti`, `id_user_properti`, `id_blok_properti`, `nama_properti`, `alamat_properti`, `kategori_properti`, `status_properti`, `kota_properti`, `luas_properti`, `luas_tanah_properti`, `tipe_properti`, `harga_properti`, `tempat_tidur`, `tempat_mandi`, `foto1_properti`, `foto2_properti`, `foto3_properti`, `foto4_properti`, `foto5_properti`) VALUES
(1, 0, 0, 'Perumahan malang ', 'Malang', '', 0, 'apartments', 190, 200, 'apartments', 2147483647, 2, 2, 'file_1583132316.JPG', '', '', '', '');
...
INSERT INTO `tb_resi` (`id_resi`, `id_user_resi`, `id_properti_user`, `tanggal_pembayaran`, `harga_dp`, `foto_resi`) VALUES
(1, 1, 1, 1580781635, 20000000, '');
...
INSERT INTO `tb_testimoni` (`id_testimoni`, `id_user_testimoni`, `rating_testimoni`, `testimoni`) VALUES
(1, 1, 4, 'Website terbaik dan terbagus\r\n');
...
INSERT INTO `tb_user` (`id_user`, `id_bank_user`, `nama_user`, `email`, `password`, `foto_user`, `no_telepon`, `alamat_user`, `tanggal_lahir`, `tempat_lahir`, `tentang_user`, `tanggal_daftar`, `aktif_akun`, `status`) VALUES
(1, 1, 'Hafid', 'hafidyt18@gmail.com', '$2y$10$RpDyeCN1VYYJyiZ7ydhXfei4kAJTbFfj2vtAxn1c8SgNkQLWqHuea', 'default.png', 123, 'Malang', 24072002, 'Panjen', 'Hafid power ranger', 1580781635, 1, 3);
...
--
ALTER TABLE `tb_resi`
  MODIFY `id_resi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
